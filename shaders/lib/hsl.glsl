...
// Harmony operations — angle math mod 360
...
// Generate n analogous hues spread symmetrically around baseHue — fills the HSL circle evenly near one region
